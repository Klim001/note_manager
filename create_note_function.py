...
Программа должна автоматически добавлять текущую дату в поле created_date с использованием библиотеки datetime.
Реализуйте проверку корректности формата для поля issue_date (например, "день-месяц-год").

3. Вызовите функцию в конце файла, чтобы продемонстрировать её работу. Выведите результат работы функции на экран.
'''
